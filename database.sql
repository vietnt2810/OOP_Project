...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 01, 2020 lúc 09:20 AM
...
--
-- Cơ sở dữ liệu: `dtb_xemvui`
--
CREATE DATABASE IF NOT EXISTS `dtb_xemvui` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci;
USE `dtb_xemvui`;
--
-- Cơ sở dữ liệu: `oop`
--
CREATE DATABASE IF NOT EXISTS `oop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci;
USE `oop`;
...
CREATE TABLE `account` (
  ...
  `avatarUrl` varchar(50) COLLATE utf8mb4_vietnamese_ci DEFAULT '/avatar/default-avatar.jpg'
...
(2, 'b', 'b', './avatar/default-avatar.jpg'),
...
('root', '[{\"db\":\"oop\",\"table\":\"account\"},{\"db\":\"oop\",\"table\":\"user\"}]');
...
('root', 'oop', 'user', '{\"sorted_col\":\"`user`.`usrLevel`  DESC\"}', '2020-06-01 03:46:53');
...
('root', '2020-06-01 07:19:59', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"vi\"}');
