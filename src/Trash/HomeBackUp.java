 ...
 * @author thao
 */
public class HomeBackUp extends javax.swing.JFrame {
    ...
    private void LogoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutButtonActionPerformed
        ...
        LoginBackup login = new LoginBackup();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeBackUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() { 
                new HomeBackUp().setVisible(true);     
            }
        });
    }
